...
void eight_cpu_numbers(double *uret, double *nret, double *sret, double *iret, double *wret, double *xret, double *yret, double *zret){
...
void getstat(jiff *cuse, jiff *cice, jiff *csys, jiff *cide, jiff *ciow, jiff *cxxx, jiff *cyyy, jiff *czzz,
	     unsigned long *pin, unsigned long *pout, unsigned long *s_in, unsigned long *sout,
	     unsigned *intr, unsigned *ctxt,
	     unsigned int *running, unsigned int *blocked,
	     unsigned int *btime, unsigned int *processes) {
  static int fd;
