...
#define USAGE_HEADER_P    "\nUsage:\n"
#define USAGE_OPTIONS_P   "\nOptions:\n"
#define USAGE_SEPARATOR_P "\n"
#define USAGE_HELP_P      " -h, --help     display this help and exit\n"
#define USAGE_VERSION_P   " -V, --version  output version information and exit\n"

#define PROCPS_NG_VERSION _("%s from %s\n"), program_invocation_short_name, PACKAGE_STRING
#define PROCPS_NG_VERSION_P "%s from %s\n", program_invocation_short_name, PACKAGE_STRING
